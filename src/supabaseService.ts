  ...
  try {
    ...
    if (isRegister) {
      ...
      if (loginErr) {
        ...
        if (profile && !dbQueryErr) {
          ...
          const userObject = {
            ...
            email: profile.email,
            avatar: profile.avatar_url || 'https://api.dicebear.com/7.x/adventurer/svg?seed=avatar',
            points: 0,
            exactCount: 0,
            winnerCount: 0,
      ...
      const userObject = {
        ...
        name: profile.full_name || 'Usuário',
        email: profile.email,
        avatar: profile.avatar_url || 'https://api.dicebear.com/7.x/adventurer/svg?seed=user',
