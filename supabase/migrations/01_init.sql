...
-- Todos os usuários autenticados podem ver todos os palpites (para detalhamento no ranking)
CREATE POLICY "All auth users can view all bets" 
ON public.bets FOR SELECT 
...
-- Administrador pode atualizar todos os palpites (necessário para calcular pontos ao definir resultado)
